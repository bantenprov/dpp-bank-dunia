<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Distribusi Pembagian Pengeluaran per kapita Bank Dunia
...
export default {
  ...
  methods: {
    createRow() {
      window.location = '#/admin/dpp-bank-dunia/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/dpp-bank-dunia/' + rowData.id;
    },
    editRow(rowData) {
      window.location = '#/admin/dpp-bank-dunia/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
      let app = this;

      if (confirm('Do you really want to delete it?')) {
        axios.delete('/api/dpp-bank-dunia/' + rowData.id)
